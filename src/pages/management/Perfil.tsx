...
const Perfil: React.FC = () => {
  ...
  const loadProfileData = async () => {
    try {
      ...
      // Pegar o primeiro funcionário como exemplo (ou usar lógica de usuário logado)
      ...
      const profileData = {
        ...
        email: currentEmployee.user?.email || `${(currentEmployee.name || 'usuario').toLowerCase().replace(' ', '.')}@empresa.com`,
        phone: '+55 (11) 99999-9999', // Pode ser adicionado ao modelo depois
