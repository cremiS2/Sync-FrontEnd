    ...
    <div className="w-screen min-h-screen" style={{ background: 'var(--bg-gradient)' }}>
      ...
      <main className={`transition-all duration-300 pt-14 sm:pt-16 ml-0 ${
        ...
        <div className="p-3 sm:p-4 md:p-6 min-h-screen animate-fadeInUp" style={{ background: 'var(--bg-gradient)' }}>
          ...
          {/* KPI Cards Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-2 notebook:grid-cols-4 gap-2 sm:gap-4 md:gap-6 notebook:gap-8 mb-4 sm:mb-6 md:mb-8 items-start"
            ...
            <div className={`rounded-xl sm:rounded-2xl shadow-sm border-2 p-3 sm:p-5 md:p-6 hover:shadow-lg transition-all duration-300 ${
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <p className={`text-[10px] sm:text-xs font-semibold mb-1 sm:mb-2 uppercase tracking-wide ${
                    isDarkMode ? "text-gray-400" : "text-gray-600"
                  }`}>Total de Máquinas</p>
            ...
            <div className={`rounded-xl sm:rounded-2xl shadow-sm border-2 p-3 sm:p-5 md:p-6 hover:shadow-lg transition-all duration-300 ${
              ...
              <div className="flex items-start justify-between">
                ...
                <div className={`w-8 h-8 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0 ${
                  ...
                  <FaCheckCircle className={`text-sm sm:text-lg md:text-xl ${
          ...
          <ResponsiveGrid
            ...
            renderItem={(machine) => {
              ...
              return (
                <div
                  className={`rounded-xl sm:rounded-2xl shadow-sm border p-3 sm:p-5 md:p-6 hover:shadow-lg transition-all duration-300 cursor-pointer h-full overflow-hidden flex flex-col ${
                    isDarkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"
                  }`}
                ...
                >
                  <div className="mb-3 sm:mb-4">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                      <Avatar
                        ...
                        className={`w-10 h-10 sm:w-14 sm:h-14 border-2 sm:border-4 shadow-lg flex-shrink-0 ${
                      ...
                      <div className="min-w-0 flex-1">
                        <h3 className={`text-sm sm:text-lg font-bold mb-0.5 sm:mb-1 truncate ${
                          isDarkMode ? "text-white" : "text-gray-900"
                        }`} title={machine.name}>{machine.name}</h3>
                  ...
                  <div className="mb-3 sm:mb-4 flex-grow">
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:gap-3">
                      <div className={`text-center p-2 sm:p-3 rounded-xl ${
                        isDarkMode ? "bg-gray-700/50" : "bg-gray-50"
                      }`}>
                        <p className={`text-[10px] sm:text-xs mb-0.5 ${
                          isDarkMode ? "text-gray-400" : "text-gray-600"
                        }`}>OEE</p>
                  ...
                  <div className="flex gap-1.5 sm:gap-2 mt-auto">
                    <Button
                      variant="contained"
                      startIcon={<FaEye className="text-xs sm:text-sm" />}
                      size="small"
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    <Button
                      variant="outlined"
                      startIcon={<FaEdit className="text-xs sm:text-sm" />}
                      size="small"
                      onClick={(e) => {
                        e.stopPropagation();
        ...
        >
          {selectedMachine && (
            <>
              <DialogTitle className="bg-gradient-to-r from-blue-600 to-blue-800 text-white" sx={{ overflow: 'hidden' }}>
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <h2 className="text-xl font-semibold truncate" title={selectedMachine.name}>{selectedMachine.name}</h2>
              ...
              <DialogContent className={`p-8 ${isDarkMode ? "bg-gray-800" : "bg-white"}`} sx={{ overflow: 'auto' }}>
                      ...
                      <div className={`p-4 rounded-lg border overflow-hidden ${isDarkMode ? "bg-gray-700 border-gray-600" : "bg-blue-50 border-blue-200"}`}>
                        ...
                        <div className="space-y-3">
                          <div className="flex justify-between gap-2">
                            <span className={`font-semibold flex-shrink-0 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Nome:</span>
                            <span className={`font-bold truncate ${isDarkMode ? "text-white" : "text-gray-900"}`} title={selectedMachine.name}>{selectedMachine.name}</span>
                          </div>
                          <div className="flex justify-between gap-2">
                            <span className={`font-semibold flex-shrink-0 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Modelo:</span>
                            <span className={`font-bold truncate ${isDarkMode ? "text-white" : "text-gray-900"}`} title={selectedMachine.model}>{selectedMachine.model}</span>
                          </div>
                          <div className="flex justify-between gap-2">
                            <span className={`font-semibold flex-shrink-0 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Status:</span>
                          ...
                          <div className="flex justify-between gap-2">
                            <span className={`font-semibold flex-shrink-0 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>Departamento:</span>
                            <span className={`font-bold truncate ${isDarkMode ? "text-white" : "text-gray-900"}`} title={selectedMachine.department}>{selectedMachine.department}</span>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <DialogActions className={`p-6 border-t-2 ${isDarkMode ? "border-gray-700 bg-gray-800" : "border-gray-200 bg-white"}`}>
                <div className="flex gap-3 w-full justify-between">
                  <Button
                    ...
                    onClick={() => {
                      window.open('https://monitoramentoml.up.railway.app/', '_blank');
                    }}
                    sx={{
