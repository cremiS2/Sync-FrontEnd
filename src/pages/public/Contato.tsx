    ...
    <>
      ...
      <main className="min-h-screen w-full flex flex-col items-center py-10 px-4">
        <section className="max-w-xl w-full mx-auto text-center mb-10">
          <h1 className="text-3xl font-bold text-[var(--primary)] dark:text-[var(--primary)] mb-4 animate-fadeInUp">Fale com a Sync</h1>
          <p className="text-base text-[var(--text)] mb-6 leading-relaxed animate-fadeInUp" style={{ animationDelay: '100ms' }}>
            Entre em contato para dúvidas, sugestões, parcerias ou agendar uma demonstração. Nossa equipe terá prazer em responder!
          </p>
        </section>
        <section className="max-w-xl w-full mx-auto rounded-xl border shadow-sm p-8 mb-8 animate-fadeInUp bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700" style={{ animationDelay: '200ms' }}>
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <input
              ...
              className="px-4 py-3 rounded-lg border bg-white dark:bg-[var(--input-bg-dark)] text-gray-800 dark:text-[var(--text)] border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-[var(--primary)] outline-none transition-all duration-200"
              autoComplete="name"
              disabled={loading}
              required
            />
            ...
            <textarea
              ...
              className="px-4 py-3 rounded-lg border bg-white dark:bg-[var(--input-bg-dark)] text-gray-800 dark:text-[var(--text)] border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-[var(--primary)] outline-none transition-all duration-200 min-h-[100px] resize-y"
              disabled={loading}
              required
            />
