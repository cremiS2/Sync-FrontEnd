...
import { FaArrowLeft, FaChartLine, FaCogs, FaShieldAlt, FaUsers, FaRocket, FaCheckCircle } from 'react-icons/fa';
    ...
    <>
      ...
      <main className="min-h-screen w-full flex flex-col items-center py-10 px-4">
        ...
        <div className="w-full max-w-7xl mb-6">
          <Link 
            to="/" 
            className="inline-flex items-center gap-2 bg-[var(--primary)] text-white px-4 py-2 rounded-lg hover:bg-[var(--primary-dark)] font-semibold transition-colors shadow-md"
          >
            <FaArrowLeft />
        ...
        <section className="max-w-7xl w-full mx-auto text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-[var(--text)] mb-6 animate-fadeInUp">Por que escolher a <span className="sync-logo-light" style={{ color: '#ffffff' }}>SYNC</span>?</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((f, i) => (
              <div
                key={i}
                className="group p-8 rounded-2xl border transform hover:-translate-y-2 transition-all duration-300 animate-fadeInUp bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:border-[var(--primary)] hover:shadow-xl"
