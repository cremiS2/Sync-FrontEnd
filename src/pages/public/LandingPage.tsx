...
// Componente de estatística com contador - Design limpo e profissional
const StatCounter: React.FC<{ number: string; label: string; isVisible: boolean }> = ({ number, label, isVisible }) => {
  ...
  return (
    <div className="text-center py-2 sm:py-4">
      <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-1 sm:mb-2 text-white">
        {displayCount}{suffix}
      </div>
      <div className="text-xs sm:text-sm md:text-base text-white/80 font-medium">{label}</div>
    </div>
  );
};
...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Features Section */}
      <section className="py-6 sm:py-10 md:py-24 landing-features" ref={featuresSectionRef}>
        <div 
        ...
        >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8">
            {[
              ...
              >
                <div className="w-10 h-10 md:w-16 md:h-16 bg-[var(--primary)] rounded-lg md:rounded-xl flex items-center justify-center mb-2 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <span className="text-white text-lg md:text-2xl">{feature.icon}</span>
                </div>
      ...
      {/* Stats Section */}
      <section className="py-6 sm:py-10 md:py-16 bg-gray-800 text-white landing-stats">
        <div 
          ref={statsReveal.ref}
      ...
      <section className="py-6 sm:py-10 md:py-24 landing-testimonials" ref={testimonialsSectionRef}>
        <div 
      ...
      {/* CTA Section */}
      <section className="py-6 sm:py-10 md:py-24 bg-gradient-to-br from-[var(--primary)] to-[var(--primary-dark)] text-white">
        <div 
          ref={ctaReveal.ref}
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-white py-6 sm:py-8 md:py-16">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          {/* Logo e descrição - sempre em cima no mobile */}
          <div className="mb-6 md:hidden">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-base sync-logo" style={{ color: '#60a5fa' }}>SYNC</h3>
            </div>
            <p className="text-gray-400 mb-3 text-xs">
              Transformando a indústria com tecnologia de ponta.
            </p>
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            ...
            {/* Produto */}
            <div>
              <h4 className="font-semibold mb-3 sm:mb-4 text-white text-sm sm:text-base">Produto</h4>
              <ul className="space-y-2 sm:space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Recursos</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Preços</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Integrações</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">API</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Sobre</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Carreiras</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Blog</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Imprensa</a></li>
              </ul>
            </div>

            {/* Suporte */}
            <div>
              <h4 className="font-semibold mb-3 sm:mb-4 text-white text-sm sm:text-base">Suporte</h4>
              <ul className="space-y-2 sm:space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Ajuda</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Docs</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Contato</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[var(--primary)] transition-colors text-xs sm:text-sm py-1 block">Status</a></li>
              </ul>
            </div>
          </div>

          <div className="border-t border-gray-700 mt-6 sm:mt-12 pt-4 sm:pt-8 text-center">
            <p className="text-gray-400 text-xs sm:text-sm">&copy; 2024 <span className="sync-logo" style={{ color: '#60a5fa' }}>SYNC</span>. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
