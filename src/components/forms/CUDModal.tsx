  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="bg-gradient-to-br from-[var(--primary)] via-[var(--primary-dark)] to-[#e55a1a] p-4 sm:p-6">
      ...
      <DialogContent className="p-4 sm:p-6 md:p-8 pt-4 sm:pt-6 md:pt-8">
        <Paper elevation={0} className="bg-gray-50 rounded-xl p-4 sm:p-6">
      ...
      {/* Ações */}
      <DialogActions className="p-4 sm:p-6 bg-gray-50">
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 border-2 border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
          >
            <FaTimes />
            <span>Cancelar</span>
          </button>
