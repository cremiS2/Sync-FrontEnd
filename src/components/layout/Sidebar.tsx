...
import { 
  ...
  FaFileAlt, FaBell, FaUserShield, FaSignOutAlt,
...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, onToggle }) => {
  ...
  return (
    <div className={`fixed left-0 top-14 sm:top-16 h-[calc(100vh-3.5rem)] sm:h-[calc(100vh-4rem)] bg-gradient-to-b from-[var(--primary)] to-[var(--primary-dark)] transition-all duration-300 z-30 ${
      ...
      <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-4 border-t border-white/10">
        <button 
          ...
          className="w-full flex items-center gap-2 sm:gap-3 px-2 sm:px-3 py-2 sm:py-2.5 rounded-lg text-white/80 hover:bg-white/10 hover:text-white transition-colors"
        >
